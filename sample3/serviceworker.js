...
// var filesToCache = [ '/',
// '/homepage.html','adminlogin.html','sample4.html','p1.html','p2.html'
// ];
...
// 	if (!matching || matching.status == 404) { return cache.match("homepage.html");
// 	} else {
// 	return matching;
// 	}
// 	});
...
self.addEventListener("install", function (event) {
	...
	event.waitUntil(self.registration.showNotification("RED STORE", {body:
	data.message}))
	}
	}
	})
	...
	return cache.match("homepage.html");
	} else {
	return matching;
	}
	});
